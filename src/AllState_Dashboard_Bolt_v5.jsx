...
// ── STATIC DATA ────────────────────────────────────────────────────────────────
const COUNCILS_DATA = [
  { id:"GC", name:"Gold Coast City Council", url:"vendorpanel.com.au/goldcoastcity/tenders", href:"https://www.vendorpanel.com.au/goldcoastcity/tenders", note:"Full VendorPanel · Existing relationship · Panel supplier · All tenders, EOIs and RFQs published here", status:"Registered", statusColor:"#2E7D5F", priority:"Primary target", priorityColor:"#C9A96E" },
  { id:"LC", name:"Logan City Council", url:"vendorpanel.com.au/logancity/tenders", href:"https://www.vendorpanel.com.au/logancity/tenders", note:"Fully on VendorPanel · Must be registered on VP Marketplace to receive invites · All RFTs, EOIs and RFQs here", status:"Registered", statusColor:"#2E7D5F", priority:"High priority", priorityColor:"#E05C4A" },
  { id:"IC", name:"Ipswich City Council", url:"ipswich.qld.gov.au · VendorPanel", href:"https://www.ipswich.qld.gov.au/Business/Doing-Business-with-Council", note:"VendorPanel for all procurement · RFQs up to $50K · 3 quotes via VP up to $500K · Formal tender above $500K", status:"Registered", statusColor:"#2E7D5F", priority:"High priority", priorityColor:"#E05C4A" },
  { id:"RC", name:"Redland City Council", url:"vendorpanel.com.au — Redland", href:"https://www.vendorpanel.com.au/PublicTenders.aspx?mode=all&emcc=1B8EA6C1B2AD", note:"Primary e-sourcing system is VendorPanel · All public tenders listed · Register on VP Marketplace", status:"Registered", statusColor:"#2E7D5F", priority:"Medium priority", priorityColor:"#C97530" },
  { id:"SC", name:"Sunshine Coast Council", url:"sunshinecoast.qld.gov.au/tenders", href:"https://www.sunshinecoast.qld.gov.au/council/tenders/current-tenders", note:"Moved ALL public tenders to VendorPanel effective 21 Sept 2024 · Active tenders regularly closing", status:"Registered", statusColor:"#2E7D5F", priority:"Medium priority", priorityColor:"#C97530" },
  { id:"SR", name:"Scenic Rim Regional Council", url:"vendorpanel.com.au/scenicrim/tenders", href:"https://www.vendorpanel.com.au/scenicrim/tenders", note:"VendorPanel Marketplace for RFQs <$200K · Good for early relationship building · Smaller volume council", status:"Registered", statusColor:"#2E7D5F", priority:"Lower priority", priorityColor:"#6B6560" },
  { id:"BC", name:"Brisbane City Council", url:"brisbane.qld.gov.au/current-tenders", href:"https://www.brisbane.qld.gov.au/business/council-tenders-and-market-led-proposals/current-tenders", note:"SAP Ariba procurement platform · All major tenders published here · Supplier registration separate from VendorPanel · Active tender: Displacement Mitigation of Concrete Footpaths (closes 23 Mar 2026)", status:"Registered", statusColor:"#2E7D5F", priority:"High priority", priorityColor:"#E05C4A" },
];

const OTHER_PORTALS_DATA = [
  { id:"SH",  name:"Shadforth Contractor Portal",           url:"shadforth.com.au/contractors",                    href:"https://www.shadforth.com.au",               note:"Subcontractor/contractor registration portal · Registered and active", status:"Registered", statusColor:"#2E7D5F", priority:"Active", priorityColor:"#2E7D5F" },
  { id:"EE",  name:"Endeavour Energy — e-Procurement",      url:"endeavourenergy.com.au/suppliers",                href:"https://www.endeavourenergy.com.au",          note:"Electricity distributor · Greater Western Sydney, Southern Highlands, Blue Mountains · e-Procurement Portal", status:"Registered", statusColor:"#2E7D5F", priority:"Active", priorityColor:"#2E7D5F" },
  { id:"ES1", name:"Essential Energy — Oracle Cloud",       url:"essentialenergy.com.au (Oracle Cloud)",           href:"https://www.essentialenergy.com.au",          note:"Electricity distributor · Regional & Rural NSW · Oracle Cloud procurement system", status:"Registered", statusColor:"#2E7D5F", priority:"Active", priorityColor:"#2E7D5F" },
  { id:"ES2", name:"Essential Energy — e-Procurement",      url:"essentialenergy.com.au/suppliers",                href:"https://www.essentialenergy.com.au",          note:"Essential Energy secondary e-procurement portal · Registered and active", status:"Registered", statusColor:"#2E7D5F", priority:"Active", priorityColor:"#2E7D5F" },
];
...
const HitCard = ({ c }) => {
  const relColor = c.relevance === "DIRECT" ? "#2E7D5F" : c.relevance === "INDIRECT" ? "#C97530" : "#6B6560";
  return (
    <div style={{ background:"#131210", border:"1px solid #1E1C18", borderLeft:`3px solid ${relColor}`, padding:"16px 18px", display:"flex", gap:"14px" }}>
      <div style={{ width:"44px", height:"44px", background:`${relColor}18`, border:`1px solid ${relColor}`, display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"monospace", fontSize:"9px", fontWeight:700, color:relColor, flexShrink:0, textAlign:"center", lineHeight:"1.2" }}>{c.id}</div>
      <div style={{ flex:1, minWidth:0 }}>
        <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", gap:"8px", marginBottom:"3px" }}>
          <div style={{ fontWeight:600, fontSize:"13px" }}>{c.name}</div>
          <div style={{ display:"flex", gap:"6px", flexShrink:0 }}>
            <Badge label={c.relevance} color={relColor} />
            <Badge label={c.priority} color={c.pColor} />
          </div>
        </div>
        <div style={{ fontFamily:"monospace", fontSize:"8px", color:"#6B6560", letterSpacing:"1px", textTransform:"uppercase", marginBottom:"4px" }}>{c.type}</div>
        <div style={{ fontSize:"11px", color:"#8A8078", lineHeight:"1.5", marginBottom:"8px" }}>{c.rel}</div>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"8px", marginBottom:"8px" }}>
          <div style={{ background:"#0D0C0A", padding:"8px 10px", borderLeft:"2px solid #2A2720" }}>
            <div style={{ fontFamily:"monospace", fontSize:"7px", color:"#6B6560", letterSpacing:"1px", textTransform:"uppercase", marginBottom:"3px" }}>Portal / Registration</div>
            <a href={c.portalHref} target="_blank" rel="noreferrer" style={{ color:"#C9A96E", fontSize:"10px", fontFamily:"monospace", textDecoration:"none", wordBreak:"break-all" }}>{c.portal}</a>
          </div>
          <div style={{ background:"#0D0C0A", padding:"8px 10px", borderLeft:"2px solid #2A2720" }}>
            <div style={{ fontFamily:"monospace", fontSize:"7px", color:"#6B6560", letterSpacing:"1px", textTransform:"uppercase", marginBottom:"3px" }}>Work Types</div>
            <div style={{ fontSize:"10px", color:"#6B6560", lineHeight:"1.5" }}>{c.works}</div>
          </div>
        </div>
        <div style={{ background:`${relColor}10`, border:`1px solid ${relColor}30`, padding:"8px 10px", borderRadius:"2px" }}>
          <div style={{ fontFamily:"monospace", fontSize:"7px", color:relColor, letterSpacing:"1px", textTransform:"uppercase", marginBottom:"3px" }}>Action Required · <span style={{ color:c.sColor }}>{c.status}</span></div>
          <div style={{ fontSize:"11px", color:"#C0B8A8", lineHeight:"1.5" }}>{c.action}</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ background: hasStatus ? (statusCfg?.bg || "#131210") : tender.id === 1 ? "rgba(201,169,110,0.04)" : "#131210", border:`1px solid ${hasStatus ? statusCfg?.color+"44" : tender.id === 1 ? "rgba(201,169,110,0.25)" : "#1E1C18"}`, borderLeft:`3px solid ${leftBorderColor}`, marginBottom:"3px" }}>
      <div onClick={() => setExpanded(!expanded)} style={{ display:"grid", gridTemplateColumns:"1fr 200px 120px 80px 80px 90px 90px 110px 160px", gap:"8px", alignItems:"center", padding:"10px 14px", cursor:"pointer" }}>
        ...
        <div style={{ fontSize:"10px", lineHeight:"1.4", fontStyle:"italic", color: tender.summary ? "#8A8078" : "#3A3530" }}>{tender.summary ? (tender.summary.length > 90 ? tender.summary.substring(0,88)+"…" : tender.summary) : "—"}</div>
      ...
      {expanded && (
        <div style={{ borderTop:"1px solid #1E1C18", background:"#0F0E0B" }}>
          {tender.summary && (
            <div style={{ padding:"12px 14px 10px", borderBottom:"1px solid #1E1C18" }}>
              <div style={{ fontFamily:"monospace", fontSize:"8px", letterSpacing:"2px", textTransform:"uppercase", color:"#2E7D5F", marginBottom:"5px" }}>Summary</div>
              <div style={{ fontSize:"12px", color:"#C0B8A8", lineHeight:"1.6" }}>{tender.summary}</div>
            </div>
          )}
...
export default function App() {
  ...
  const TABS = [
    ...
    { id:"councils", label:"Council / Portals / Panels" },
    { id:"hitlist", label:"🎯 Client Hit List" },
  ...
  // Auto-refresh every 3 minutes when a sheets URL is connected
  ...
  return (
    ...
    <div style={{ minHeight:"100vh", background:"#0D0C0A", color:"#E8E0D0", fontFamily:"system-ui, sans-serif" }}>
      ...
      <header style={{ background:"#131210", borderBottom:"1px solid #1E1C18", padding:"0 24px", display:"flex", alignItems:"center", gap:"16px", height:"56px", position:"sticky", top:0, zIndex:100, flexWrap:"nowrap", overflowX:"auto" }}>
        <img src={LOGO_WHITE} alt="AllState Kerbing" style={{ height:"80px", width:"auto", flexShrink:0 }} />
        <div style={{ width:"1px", height:"32px", background:"#2A2720", flexShrink:0 }} />
        <div style={{ display:"flex", flexDirection:"column", gap:"2px", flexShrink:0 }}>
          <div style={{ fontFamily:"monospace", fontSize:"8px", letterSpacing:"2px", textTransform:"uppercase", color:"#6B6560" }}>SEQ Strategy · 2026</div>
          <div style={{ fontFamily:"monospace", fontSize:"7px", letterSpacing:"1px", color:"#3A3530" }}>v2.1.0</div>
        </div>
        <div style={{ marginLeft:"auto", display:"flex", alignItems:"center", gap:"4px", flexShrink:0 }}>
          {liveStatus === "live" && (
            <div style={{ display:"flex", alignItems:"center", gap:"5px", padding:"4px 10px", background:"rgba(46,125,95,0.08)", border:"1px solid rgba(46,125,95,0.3)", borderRadius:"2px", marginRight:"6px" }}>
              ...
              <button onClick={() => { fetchFromSheets(sheetsUrl); setNextRefresh(180); }} style={{ background:"none", border:"none", color:"#2E7D5F", fontSize:"10px", cursor:"pointer", padding:"0 2px" }}>↻</button>
            </div>
          )}
      ...
      {/* ── TAB: COUNCIL / PORTALS / PANELS ── */}
      {activeTab === "councils" && (
        <div style={tabPad}>
          <PT title="Council / Portals / Panels" sub="All 7 SEQ councils registered (6 via VendorPanel · Brisbane via SAP Ariba). Energy and contractor portals also registered." />
          <SL mt="0">Council Portals — Registered</SL>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:"12px", marginBottom:"24px" }}>
            {COUNCILS_DATA.map(c => (
              <div key={c.id} style={{ background:"#131210", border:"1px solid #1E1C18", borderLeft:"3px solid #2E7D5F", padding:"16px 18px", display:"flex", gap:"14px" }}>
                <div style={{ width:"40px", height:"40px", background:"rgba(46,125,95,0.1)", border:"1px solid #2E7D5F", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"monospace", fontSize:"11px", fontWeight:700, color:"#2E7D5F", flexShrink:0 }}>{c.id}</div>
                <div style={{ flex:1 }}>
                  <div style={{ fontWeight:600, fontSize:"13px", marginBottom:"3px" }}>{c.name}</div>
                  <div style={{ fontFamily:"monospace", fontSize:"9px", color:"#2E7D5F", letterSpacing:"0.5px", marginBottom:"6px" }}><a href={c.href} target="_blank" rel="noreferrer" style={{ color:"#2E7D5F", textDecoration:"none" }}>{c.url}</a></div>
          ...
          <SL>Other Portals & Panels — Registered</SL>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:"12px", marginBottom:"24px" }}>
            {OTHER_PORTALS_DATA.map(c => (
              <div key={c.id} style={{ background:"#131210", border:"1px solid #1E1C18", borderLeft:"3px solid #2E7D5F", padding:"16px 18px", display:"flex", gap:"14px" }}>
                <div style={{ width:"40px", height:"40px", background:"rgba(46,125,95,0.1)", border:"1px solid #2E7D5F", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"monospace", fontSize:"10px", fontWeight:700, color:"#2E7D5F", flexShrink:0 }}>{c.id}</div>
                <div style={{ flex:1 }}>
                  <div style={{ fontWeight:600, fontSize:"13px", marginBottom:"3px" }}>{c.name}</div>
                  <div style={{ fontFamily:"monospace", fontSize:"9px", color:"#2E7D5F", letterSpacing:"0.5px", marginBottom:"6px" }}><a href={c.href} target="_blank" rel="noreferrer" style={{ color:"#2E7D5F", textDecoration:"none" }}>{c.url}</a></div>
                  <div style={{ fontSize:"11px", color:"#6B6560", lineHeight:"1.6", marginBottom:"8px" }}>{c.note}</div>
      ...
      {activeTab === "hitlist" && (
        <div style={tabPad}>
          <PT title="Client Hit List" sub="Target organisations for direct relationship building and subcontractor registration. Register on each portal, then follow up with a capability statement and direct contact." />

          {/* ── GOVERNMENT ROAD AUTHORITIES ── */}
          <SL mt="0">Government Road Authorities — Direct state road & civil maintenance scope</SL>
          <div style={{ display:"grid", gridTemplateColumns:"1fr", gap:"10px", marginBottom:"24px" }}>
            {[
              { id:"RT", name:"Roadtek (TMR)", type:"Govt Road Authority", relevance:"DIRECT", rel:"State road construction & maintenance across QLD — kerb & channel, drainage, reinstatement on the state highway network", priority:"Very High", pColor:"#E05C4A", portal:"tmr.qld.gov.au/approved-suppliers + QTenders", portalHref:"https://www.tmr.qld.gov.au/business-industry/business-with-us/approved-products-and-suppliers", status:"Register Now", sColor:"#E05C4A", works:"Kerb & channel · Road rehab · Concrete drainage · Footpath · Civil maintenance", action:"Register on TMR Approved Suppliers list AND on QTenders. Contact Gold Coast & Brisbane regional RoadTek offices directly with capability statement." },
              { id:"DW", name:"Downer Group (QTMP)", type:"Road Maintenance Contractor", relevance:"DIRECT", rel:"Holds Queensland TMR road maintenance contracts across SEQ — actively subcontracts kerb & channel repair work", priority:"Very High", pColor:"#E05C4A", portal:"downergroup.com/supplier-registration · SupplyTMR: supplytmr.benchon.com", portalHref:"https://www.downergroup.com/supplier-registration", status:"Register Now", sColor:"#E05C4A", works:"TMR road maintenance · Kerb repair · Concrete works · Drainage · Footpaths", action:"Register at downergroup.com/supplier-registration AND on SupplyTMR portal for QTMP work packages. Reference Gold Coast & SEQ civil work." },
            ].map(c => <HitCard key={c.id} c={c} />)}
          </div>

          {/* ── TIER-1 CIVIL CONTRACTORS ── */}
          <SL>Tier-1 Civil Contractors — Register as subcontractor on their packages</SL>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:"10px", marginBottom:"24px" }}>
            {[
              { id:"BMD", name:"BMD Constructions", type:"Civil Tier-1 Contractor", relevance:"DIRECT", rel:"Road & civil packages throughout SEQ include kerb & channel from Burleigh to Caboolture", priority:"High", pColor:"#E05C4A", portal:"contractor.bmd.com.au (CMS Portal)", portalHref:"https://contractor.bmd.com.au/", status:"Register Now", sColor:"#E05C4A", works:"Roads · Urban development · Stormwater · Kerb & channel · Streetscapes", action:"Register on BMD CMS portal. Upload QBCC licence, insurances, capability statement. Target their SEQ road packages." },
              { id:"FH", name:"Fulton Hogan", type:"Civil Tier-1 Contractor", relevance:"DIRECT", rel:"Major QLD road construction & maintenance — kerb & channel throughout all road packages statewide", priority:"High", pColor:"#E05C4A", portal:"ICN Gateway: gateway.icn.org.au · Direct: fultonhogan.com/contact-us", portalHref:"https://gateway.icn.org.au/suppliers/66913", status:"Direct Contact", sColor:"#C97530", works:"State roads · Local roads · Pavements · Kerb & channel · Road rehab", action:"Register on ICN Gateway. Send capability statement to QLD civil procurement. Track them on EstimateOne for active packages." },
              { id:"GLD", name:"Golding Contractors (NRW)", type:"Civil Tier-1 Contractor", relevance:"DIRECT", rel:"Urban development division builds roads, drainage, kerbing for residential & commercial estates across SEQ", priority:"High", pColor:"#E05C4A", portal:"nrw.com.au/our-business/golding · ICN Gateway", portalHref:"https://nrw.com.au/our-business/golding/", status:"Direct Contact", sColor:"#C97530", works:"Urban development · Subdivision roads · Drainage · Kerb & channel · Earthworks", action:"Contact Golding Urban Division directly. Register ICN Gateway. Pitch on subdivision kerbing capability — they deliver major SEQ estates." },
              { id:"HB", name:"Hazell Bros Group", type:"Civil Tier-1 Contractor", relevance:"DIRECT", rel:"Already active on Gold Coast tenders (Burleigh, Currumbin) — very active in ASK territory and seen frequently on EstimateOne", priority:"High", pColor:"#E05C4A", portal:"EstimateOne (already listing packages) · Direct: hazellbros.com.au", portalHref:"https://www.hazellbros.com.au/", status:"Direct Contact", sColor:"#C97530", works:"Civil infrastructure · Roads · Bridges · Earthworks · Sub-civil packages", action:"Request preferred subcontractor listing with Hazell Bros QLD office. Already active on EstimateOne — follow up Burleigh + Currumbin contacts." },
            ].map(c => <HitCard key={c.id} c={c} />)}
          </div>

          {/* ── FM & MAINTENANCE ── */}
          <SL>Facilities Management & Maintenance — Hold multi-year civil maintenance contracts</SL>
          <div style={{ display:"grid", gridTemplateColumns:"1fr", gap:"10px", marginBottom:"24px" }}>
            {[
              { id:"PRG", name:"Programmed", type:"FM & Maintenance Contractor", relevance:"DIRECT", rel:"Holds council and government road & civil maintenance contracts across SEQ — regularly subcontracts kerb & concrete repair work", priority:"High", pColor:"#E05C4A", portal:"programmed.com.au (contact Infrastructure/Civil division direct)", portalHref:"https://www.programmed.com.au/", status:"Direct Contact", sColor:"#C97530", works:"Road maintenance · Kerb & channel repair · Concrete works · Footpaths · Council civils", action:"Contact Programmed Infrastructure / Civil division directly. They hold long-term council maintenance contracts and subcontract concrete & kerb repair. Request preferred supplier listing." },
            ].map(c => <HitCard key={c.id} c={c} />)}
          </div>

          {/* ── ENERGY UTILITIES ── */}
          <SL>Energy Utilities — Substation civil, cable route reinstatement, access road kerbing</SL>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:"10px", marginBottom:"24px" }}>
            {[
              { id:"EX", name:"Energex (Energy Queensland)", type:"Electricity Distributor (SEQ)", relevance:"INDIRECT", rel:"Civil works adjacent to infrastructure: cable trenching reinstatement, substation footings, streetlighting paths & kerbing", priority:"Medium", pColor:"#C97530", portal:"VendorPanel + SAP Ariba (Energy Queensland realm)", portalHref:"https://www.energex.com.au/contractors/electrical-partners-portal/register-for-the-electrical-partners-portal", status:"Register (VP + Ariba)", sColor:"#C97530", works:"Cable route civil · Substation civil · Streetlight bases · Access paths · Reinstatement", action:"Register on VendorPanel then join Energy QLD SAP Ariba realm. See energex.com.au/contractors for registration guide." },
              { id:"PL", name:"Powerlink Queensland", type:"Transmission Network Operator", relevance:"INDIRECT", rel:"High voltage infrastructure civil works: tower foundations, substation access roads, site civil works", priority:"Medium", pColor:"#C97530", portal:"powerlink.com.au/about/suppliers · VendorPanel", portalHref:"https://www.powerlink.com.au/about/suppliers", status:"Register (VP)", sColor:"#C97530", works:"Substation civil · Tower foundations · Access roads · Site earthworks", action:"Register via powerlink.com.au/about/suppliers and on VendorPanel. Watch for project-specific supplier registers for major projects. Check ICN Gateway." },
              { id:"ARR", name:"⚠ Arrnet — Verify Name", type:"Company Name Unclear", relevance:"UNKNOWN", rel:"No Queensland company matching 'Arrnet' found. Possible matches: Arrow Energy (CSG/gas), APA Group (pipelines), or a local contractor.", priority:"Verify", pColor:"#6B6560", portal:"Unknown — please confirm company name", portalHref:"https://www.google.com.au/search?q=Arrnet+Queensland", status:"Needs Clarification", sColor:"#C0392B", works:"Unknown until company identified", action:"Please confirm the correct company name. Possible: Arrow Energy (arrowenergy.com.au), APA Group (apa.com.au), or a local contractor." },
            ].map(c => <HitCard key={c.id} c={c} />)}
          </div>

          {/* ── WATER UTILITIES ── */}
          <SL>Water Utilities — Reinstatement of kerbing & footpaths after water/sewer main works</SL>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:"10px", marginBottom:"24px" }}>
            {[
              { id:"QUU", name:"Queensland Urban Utilities", type:"Water & Sewerage (Brisbane, Ipswich)", relevance:"DIRECT", rel:"Water/sewer main works require reinstatement of kerbing, footpaths and concrete throughout Brisbane, Ipswich, Scenic Rim", priority:"High", pColor:"#E05C4A", portal:"urbanutilities.com.au/about-us/information-for-suppliers (SRM Portal)", portalHref:"https://www.urbanutilities.com.au/about-us/information-for-suppliers/becoming-a-supplier", status:"Register Now", sColor:"#E05C4A", works:"Pipe reinstatement · Kerb reinstatement · Footpath repair · Concrete patching · Civil maintenance", action:"Register via QUU SRM Portal (urbanutilities.com.au). Category: civil reinstatement / concrete works. Significant kerb reinstatement volume in Brisbane/Ipswich." },
              { id:"UW", name:"Unitywater", type:"Water & Sewerage (Moreton Bay, Sunshine Coast, Noosa)", relevance:"DIRECT", rel:"Pipeline works generate ongoing kerb & footpath reinstatement throughout Moreton Bay and Sunshine Coast regions", priority:"High", pColor:"#E05C4A", portal:"QTenders + unitywater.com/accreditation (Accredited Entity)", portalHref:"https://www.unitywater.com/about-us/our-business/procurement-and-tendering", status:"Register + Accredit", sColor:"#E05C4A", works:"Pipe reinstatement · Kerb & channel · Footpath concrete · Civil maintenance", action:"Register on QTenders. Apply for Accredited Entity status via unitywater.com/accreditation. Call (07) 5431 8304 or PO Box 953 Caboolture QLD 4510." },
              { id:"LW", name:"Logan Water", type:"Water & Sewerage (Logan)", relevance:"DIRECT", rel:"Water/sewer works through Logan require reinstatement of kerbing and concrete — already targeting Logan City Council via VendorPanel", priority:"High", pColor:"#E05C4A", portal:"VendorPanel (Logan City Council portal)", portalHref:"https://www.logan.qld.gov.au/business-and-investment/doing-business-with-council/request-for-tenders-and-eoi/Tendering-Online-Portal-VendorPanel", status:"Already Targeted", sColor:"#2E7D5F", works:"Pipe reinstatement · Kerb reinstatement · Concrete works · Civil maintenance", action:"Sits under Logan City Council procurement — already targeting via VendorPanel. Add civil reinstatement category subscription. Email privateworksapplications@logan.qld.gov.au." },
              { id:"SW", name:"Seqwater", type:"Bulk Water Authority (SEQ-wide)", relevance:"INDIRECT", rel:"Dam, pipeline and treatment plant civil works include access road kerbing, carpark & site civil upgrades at facilities across SEQ", priority:"Low", pColor:"#6B6560", portal:"QTenders (qtenders.hpw.qld.gov.au) · seqwater.com.au/supplier-information", portalHref:"https://www.seqwater.com.au/supplier-information", status:"Monitor QTenders", sColor:"#6B6560", works:"Access roads · Site civil works · Carpark upgrades · Treatment plant civil", action:"Register on QTenders and set alerts for Seqwater civil works. Lower priority — mostly large pipeline/dam works but site civil packages can suit ASK scope." },
            ].map(c => <HitCard key={c.id} c={c} />)}
          </div>
        </div>
      )}
                        ...
                        return (
                          <div key={t.id} style={{ background:"#131210", border:`1px solid ${cfg.color}44`, borderLeft:`3px solid ${cfg.color}`, padding:"16px 20px", display:"grid", gridTemplateColumns:"1fr 140px 120px 120px 160px", gap:"16px", alignItems:"center" }}>
                            <div>
                              ...
                              {t.summary && <div style={{ fontSize:"10px", color:"#8A8078", marginTop:"4px", fontStyle:"italic", lineHeight:"1.4" }}>{t.summary.length > 100 ? t.summary.substring(0,98)+"…" : t.summary}</div>}
                            ...
                            <div>
                              ...
                              <div style={{ fontFamily:"monospace", fontSize:"8px", color:"#6B6560", marginTop:"6px", lineHeight:"1.5" }}>Dashboard refreshes<br/>every 3 minutes</div>
                            </div>
